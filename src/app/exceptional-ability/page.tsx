...
export const metadata: Metadata = {
  ...
  description:
    "Nature Foundation Models (NFM) and Atlas-GS v1, ASRA nine-phase cognitive stack (Phases 1–9), StratusTalk Inc synthetic dialogue SFT and LoRA adaptation for voice AI receptionists, Hire My Agents AI workforce platform, ASDB/CMB/WMIB agent eval benchmarks, NeuroGolf 2026 remote competition automation (Cursor cloud + GitHub Actions), ASRA-Security multi-step agent red-teaming, ARC-Genome / NeuroGolf neural circuit compiler, Orbit Wars Kaggle competition pipeline (including Phase 4 NFM × ASRA × Atlas-GS), SciLayer preprints, patent, federal R&D proposals, ISSRDC presentations, adaptive scientific reasoning (ARC / Decision Biology), SciLayer platform, and shipped full-stack products.",
};
