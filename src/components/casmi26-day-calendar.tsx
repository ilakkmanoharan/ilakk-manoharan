...
export function Casmi26DayCalendar({
  dates,
  basePath = "/projects/casmi26-structure-prediction/daily",
  selected,
}: Props) {
  if (dates.length === 0) {
    return (
      <p className="text-sm text-muted-foreground">
        No daily research pages yet. The project-page-agent writes one per
