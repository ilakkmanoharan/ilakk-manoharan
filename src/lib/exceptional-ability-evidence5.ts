...
export const portfolioAgentArchitectureEvidenceSection: ExceptionalAbilitySection =
  {
    ...
    paragraphs: [
      ...
      "I built this with Next.js 16, React 19, TypeScript, Tailwind, Prisma, Turso, Vercel, Resend for email, and the MCP SDK. The point wasn't to bolt a chatbot onto a résumé—it was to own the full stack from content pipeline to session logging to a refusal-first agent other systems can actually interview.",
